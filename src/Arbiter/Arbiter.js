...
import { getKnightMoves, getRookMoves, getBishopMoves, getQueenMoves, getKingMoves, getPawnMoves, getPawnCaptures, getCastlingMoves, getPiece, getKingPosition } from './GetMove'
...
const Arbiter = {
    ...
    isStalemate : function(position,player,castleDirection) {
        ...
        const pieces = getPiece(position,player)
        ...
        //King not in check and not having any legal moves
    ...
    isCheckMate : function(position,player,castleDirection) {
        ...
        //King is in check and not have any legal moves
        return (isInCheck && moves.length === 0)
    },
